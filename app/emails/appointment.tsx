...
export const AppointmentEmail = ({
  ...
  const formattedTime = new Date(combinedDateTime).toLocaleTimeString("en-US", {
    hour: "2-digit",
    minute: "2-digit",
    hour12: true,
  });
        ...
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
              A new inquiry has been submitted through your website. Below are
              the details:
            </Text>
            <Hr style={hr} />
            <Text style={paragraph}>
              <strong>Inquiry Type:</strong> Property Viewing
            </Text>
            <Text style={paragraph}>
            ...
            <Hr style={hr} />
            <Text style={paragraph}>
              Please follow up with the client promptly to address their
              inquiry. If you have any questions, feel free to reach out to the
              support team.
            </Text>
            <Button
