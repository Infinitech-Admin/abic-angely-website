...
const RatingSection = () => {
  return (
    <section className="flex flex-col items-center gap-6 py-6 md:py-2 w-full justify-center">
      <div className="container mx-auto px-2 flex flex-col items-center justify-center">
        {/* Title Section */}
        <div className="text-center">
          <h1 className="font-bold text-2xl md:text-3xl text-violet-700">
            Share Your Experience
          </h1>
          <p className="text-sm md:text-lg text-default-500  leading-6">
              ...
              <div className="w-full md:py-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {[
                    ...
                    {
                      icon: (
                        <TbUserQuestion className="text-violet-700" size={24} />
                      ),
