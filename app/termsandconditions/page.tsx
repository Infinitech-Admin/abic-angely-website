    ...
    <section className="flex flex-col items-center w-full">
      <div className="container mx-auto px-6">
        <div className="flex flex-col">
          ...
          <div className="py-2">
            Welcome to ABIC Realty! These Terms and Conditions govern your use
            of our website and services related to property listings of Abic
            Realty and Consultancy Corporation. By accessing or using our
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="list-disc list-inside">
                <li>
                  ...
                  <Link className="text-violet-600" href={"abicrealtyph.com"}>
                    abicrealtyph.com
                  </Link>
                  , operated by ABIC Realty.
                </li>
                <li>
                  <strong>&quot;User&quot;</strong> refers to any person
            ...
            <div>
              ...
              <ul className="list-disc list-inside">
                <li>
                  The website is intended for informational purposes only
                  regarding properties listed by ABIC Realty and Consultancy
                  Corporation.
                </li>
                <li>You must be at least 18 years old to use this website.</li>
                <li>
                  You agree to provide accurate and lawful information when
                  using our services.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside">
                <li>
                  The property listings are provided for general information
                  only and do not constitute a formal offer.
                </li>
                <li>
                  Prices, availability, and features of properties are subject
                  to change without prior notice.
                </li>
                <li>
                  ABIC Realty is not responsible for any inaccuracies,
            ...
            <div>
              ...
              <ul className="list-disc list-inside">
                <li>
                  ...
                  and design, is owned or licensed by ABIC Realty.
                </li>
                <li>
                  Users may not copy, distribute, modify, or use our content
            ...
            <div>
              ...
              <ul className="list-disc list-inside">
                <li>
                  ABIC Realty is not liable for any losses, damages, or claims
            ...
            <div>
              ...
              <p>
                We respect your privacy and process your personal data as
                described in our{" "}
                <strong>
                  <Link className="text-violet-600" href={"/dataprivacy"}>
                    Privacy Policy
                  </Link>
                </strong>
                .
            ...
            <div>
              ...
              <p>
                ...
                time. Continued use of the website after changes means
            ...
            <div>
              ...
              <p>
                ...
                Philippines. Any disputes shall be resolved through legal
