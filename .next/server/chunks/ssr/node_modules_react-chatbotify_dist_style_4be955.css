/* [project]/node_modules/react-chatbotify/dist/style.css [app-client] (css) */
...
.rcb-message-prompt-container.visible {
  ...
  opacity: 1;
  animation: .3s ease-in-out rcb-animation-pop-in;
  pointer-events: auto;
}
...
.rcb-bot-message-entry {
  animation: .3s ease-in backwards rcb-animation-bot-message-entry;
}
...
.rcb-user-message-entry {
  animation: .3s ease-in backwards rcb-animation-user-message-entry;
}

.rcb-message-bot-avatar, .rcb-message-user-avatar {
  background-size: cover;
  width: 40px;
  height: 40px;
  border-radius: 50%;
...
.rcb-dot {
  ...
  margin-right: 4px;
  animation: 1s infinite rcb-animation-bot-typing;
}
...
.rcb-checkbox-row-container {
  ...
  cursor: pointer;
  background-color: #fff;
  animation: .5s ease-out rcb-animations-checkboxes-entry;
  overflow: hidden;
}
...
.rcb-options {
  ...
  animation: .5s ease-out rcb-animation-options-entry;
  overflow: hidden;
}
...
.rcb-spinner {
  ...
  animation: 1s linear infinite rcb-animation-spin;
}
...
.rcb-toggle-button.rcb-button-hide {
  opacity: 0;
  visibility: hidden;
  animation: .3s ease-in-out forwards rcb-animation-collapse;
}

.rcb-toggle-button.rcb-button-show {
  opacity: 1;
  visibility: visible;
  animation: .3s ease-in-out forwards rcb-animation-expand;
}
...
.rcb-chat-tooltip.rcb-tooltip-hide {
  opacity: 0;
  visibility: hidden;
  animation: .5s ease-in-out rcb-animation-tooltip-out;
}

.rcb-chat-tooltip.rcb-tooltip-show {
  opacity: 1;
  visibility: visible;
  animation: .5s ease-in-out rcb-animation-tooltip-in;
}
...
.rcb-attach-button-enabled, .rcb-attach-button-disabled {
  position: relative;
  display: inline-block;
  background-size: cover;
  width: 30px;
...
.rcb-attach-button-enabled input[type="file"], .rcb-attach-button-disabled input[type="file"] {
  position: absolute;
  width: 100%;
  height: 100%;
  display: none;
...
.rcb-attach-icon-enabled, .rcb-attach-icon-disabled {
  display: inline-block;
  width: 24px;
  height: 24px;
  margin-top: 2px;
...
.rcb-emoji-button-enabled, .rcb-emoji-button-disabled {
  position: relative;
  display: inline-block;
  background-size: cover;
  width: 30px;
...
.rcb-emoji-icon-enabled, .rcb-emoji-icon-disabled {
  position: relative;
  display: inline-block;
  background-size: cover;
  font-size: 20px;
...
.rcb-notification-icon:hover:after {
  width: 130%;
  height: 130%;
  opacity: 1;
}

.rcb-voice-button-enabled, .rcb-voice-button-disabled {
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
.rcb-voice-icon.on {
  animation: 1s infinite rcb-animation-ping;
}
...
/*# sourceMappingURL=node_modules_react-chatbotify_dist_style_4be955.css.map*/
